...
class PDVHandler:
    ...
    @staticmethod
    def modify_pdv_config(log_widget, config_path, connection_string, empresa, cnpj):        
        ...
        try:
            ...
            try:
                ...
                show_message(log_widget, f"ConnectionString atualizada com sucesso em {config_path}")
            ...
            try:
                ...
                app_settings_handler(root, log_widget=log_widget, config_path=config_path, additional_settings=additional_settings)

            except Exception as e:
                error_message = f"Erro ao modificar Tef_Empresa e Tef_EmpresaCNPJ em {config_path}"
                show_message(log_widget, error_message)
                raise CustomExecption(f"{error_message}: {e}")
